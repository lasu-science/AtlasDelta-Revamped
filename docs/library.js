// LibraryIndex — extraída y adaptada de app.js (navegación real, incluye
// artículos de admin — ahora leídos de forma async desde Firestore)
function LibraryIndex() {
  var root = h('div',{}, h('p',{style:{padding:'80px 24px',textAlign:'center',color:'#8a8fa8'}},'Cargando repositorio…'));

  getAllArticles().then(function(ALL){
    root.innerHTML = '';
    var container = h('div',{});
    ...
    root.innerHTML = '';
    root.appendChild(h('p',{style:{padding:'80px 24px',textAlign:'center',color:'#ef4444'}},'No se pudo cargar el repositorio: '+(err.message||err)));
  });
